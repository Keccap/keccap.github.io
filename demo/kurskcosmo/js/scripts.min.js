...
$(function(){setTimeout(function(){var e=document.getElementById("preloader");e&&!e.classList.contains("done")&&e.classList.add("done"),$("body").addClass("load")},2e3),Modernizr.objectfit||($(".mainHeader-video").each(function(){var e=$(this),t=e.find("video").attr("poster");t&&e.css("backgroundImage","url("+t+")").addClass("fallback")}),$(".imgCoverWrap").each(function(){var e=$(this),t=e.find("img").prop("src");t&&e.css("backgroundImage","url("+t+")").addClass("fallback")})),$(window).on("scroll",function(){$("body").scrollTop()<$(window).height()?setTimeout(function(){$(".mainHeader-section h1, .mainHeader-section .category").fadeIn()},150):setTimeout(function(){$(".mainHeader-section h1, .mainHeader-section .category").fadeOut()},150)}).trigger("resize"),$("img, a").on("dragstart",function(e){e.preventDefault()}),$.fn.hyphenate=function(){var e="[абвгдеёжзийклмнопрстуфхцчшщъыьэюя]",t="[аеёиоуыэюя]",n="[бвгджзклмнпрстфхцчшщ]",i=[];return i[1]=new RegExp("([йъь])("+e+e+")","ig"),i[2]=new RegExp("("+t+")("+t+e+")","ig"),i[3]=new RegExp("("+t+n+")("+n+t+")","ig"),i[4]=new RegExp("("+n+t+")("+n+t+")","ig"),i[5]=new RegExp("("+t+n+")("+n+n+t+")","ig"),i[6]=new RegExp("("+t+n+n+")("+n+n+t+")","ig"),this.each(function(){for(var e=$(this).html(),t=1;t<7;++t)e=e.replace(i[t],"$1­$2");$(this).html(e)})},$(function(){$(".articleText").hyphenate()});var e=$(".lastEvent");$(window).on("resize",function(){if(e.length>0){var t=e.eq(0).position().top,n=1;e.each(function(){var e=$(this);e.position().top==t?(e.attr("data-aos-delay",100*n),n++):(e.attr("data-aos-delay",100),n=2,t=e.position().top)})}}).trigger("resize"),setTimeout(function(){var e=document.getElementById("preloader-inside");e&&!e.classList.contains("done")&&e.classList.add("done")},150),$("#hiddenBtn").click(function(){$(this).toggleClass("is-active"),$("#hiddenMnu").toggleClass("active")}),$("#search").click(function(){$("#searchPanel").addClass("active")}),$("#offSearch").click(function(){$("#searchPanel").removeClass("active")}),jQuery(".img-svg").each(function(){var e=jQuery(this),t=e.attr("id"),n=e.attr("class"),i=e.attr("src");jQuery.get(i,function(i){var a=jQuery(i).find("svg");void 0!==t&&(a=a.attr("id",t)),void 0!==n&&(a=a.attr("class",n+" replaced-svg")),a=a.removeAttr("xmlns:a"),!a.attr("viewBox")&&a.attr("height")&&a.attr("width")&&a.attr("viewBox","0 0 "+a.attr("height")+" "+a.attr("width")),e.replaceWith(a)},"xml")});var t={itemSelector:".col",columnWidth:".col",percentPosition:!0},n=$(".masonryContainer");$(window).bind("resize",function(){Math.max(document.body.scrollWidth,document.documentElement.scrollWidth,document.body.offsetWidth,document.documentElement.offsetWidth,document.body.clientWidth,document.documentElement.clientWidth)<650&&n.masonry()?n.masonry("destroy"):n.masonry(t)}),$(window).resize(),AOS.init({duration:600,offset:200,delay:200});var i=$('.articleContainer a[href$=".jpg"]');i.fluidbox({stackIndex:50}),$(window).scroll(function(){i.fluidbox("close")})});